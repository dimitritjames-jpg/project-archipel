...
const businessBenefits = [
  "Confirm or correct your listing",
  "Send approved photos with clear rights",
  "Ask about future featured and sponsor options",
] as const;
    ...
    <section className="px-4 py-20 sm:px-6 lg:py-28" aria-labelledby="partner-cta">
      <div className="mx-auto max-w-7xl">
        <div className="island-postcard-card topographic-field relative overflow-hidden rounded-[2rem] border border-coral/15 bg-[#20111d] px-6 py-12 sm:px-10 sm:py-14 lg:px-14 lg:py-16">
          <div
            className="absolute right-[-8rem] top-[-10rem] h-[26rem] w-[26rem] rounded-full border border-coral/12"
            aria-hidden
          />
          <div
            className="absolute right-[-4rem] top-[-6rem] h-[18rem] w-[18rem] rounded-full border border-aqua/12"
            aria-hidden
          />
