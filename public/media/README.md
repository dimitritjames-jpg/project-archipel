...
- `og/` — optional static social sharing images for the root site and major guide families
...
- Current launch default social card is generated by the Next.js routes `/opengraph-image` and `/twitter-image`.
- Optional future static file: `og/vibevi-default-1200x630.webp`
...
- Open Graph: exactly `1200 x 630`; current launch default is generated at this size by `/opengraph-image`.
